...
/* harmony import */ var _user_det_pipe__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./user-det.pipe */ "./src/app/user-det.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _user_det_pipe__WEBPACK_IMPORTED_MODULE_9__["UserDetPipe"]
            ],
            imports: [
...
module.exports = "<h3>Posts</h3>\n<ul>\n  <li *ngFor=\"let post of posts$\">\n    <h3>Name: {{ post.userId | userDet: 'name' }}</h3>\n    <h4>\n      <a href=\"https://{{ post.userId | userDet: 'website' }}\">{{ post.userId | userDet: 'website' }}</a>\n    </h4>\n    <h5>{{ post.title }}</h5>\n    <p>{{ post.body }}</p>\n  </li>\n</ul>"
...
/***/ "./src/app/user-det.pipe.ts":
/*!**********************************!*\
  !*** ./src/app/user-det.pipe.ts ***!
  \**********************************/
/*! exports provided: UserDetPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserDetPipe", function() { return UserDetPipe; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _data_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data.service */ "./src/app/data.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var UserDetPipe = /** @class */ (function () {
    function UserDetPipe(data) {
        var _this = this;
        this.data = data;
        this.data.getUsers().subscribe(function (data) { return _this.users$ = data; });
    }
    UserDetPipe.prototype.ngOnInit = function () {
        this.users$ = this.users$;
    };
    UserDetPipe.prototype.transform = function (UID, Prop) {
        try {
            var user = this.users$.filter(function (x) { return x.id == UID; });
            return user[0][Prop];
        }
        catch (_a) {
            return "";
...
module.exports = __webpack_require__(/*! C:\Users\samar\Desktop\Kuebix Code Test\test-app\src\main.ts */"./src/main.ts");
